    ...
    <div style={{ padding: '1.5rem', maxWidth: '540px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <span style={{ color: '#555' }}>
          For "Open All" to work: click the popup-blocked icon in the address bar →{' '}
          <em>Always allow pop-ups from localhost</em>.<br />
          Otherwise use the individual <strong>Open →</strong> buttons below — one click per player, always works.
        </span>
      </div>
